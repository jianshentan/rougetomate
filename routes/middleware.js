...
exports.initLocals = function(req, res, next) {
  ...
  /**
   * Navigation Links 
   *   'key' needs to match the 'href' field
   * =======================================
   */
	locals.navLinks = [
...
/**
	Fetches certificates to render on each page
*/
exports.certificates = function(req, res, next) {
	var locals = res.locals;
	keystone.list('Certifications').model.find().sort('sortOrder')
	.exec(function(err, list) {
		locals.certifications = list;
		next();
  });
};
